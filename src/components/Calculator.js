...
function Calculator() {
  ...
  return (
    <section className="section button grid grid-cols-[5rem_5rem_5rem_5rem]">

      <div className="result four-cell col-span-4 bg-[#858694] text-right text-xl p-2 h-14 border border-solid border-[#cecdcd]" onChange={handleResult}>
        {total}
        {operation}
        {next}
      </div>
